...
import { Zap, Play, CheckCircle2, ArrowRight, BookOpen, Clock, Award } from "lucide-react";
...
export default function ConceptCard({
  ...
  return (
    <motion.div
      ...
      className={`glass relative overflow-hidden rounded-2xl border border-white/10 p-6 shadow-xl backdrop-blur-xl transition-all duration-300 hover:border-purple-500/30 hover:shadow-purple-500/10 ${className}`}
    >
