  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-[var(--color-bg-primary)] relative overflow-hidden">
      ...
      <GlassCard className="w-full max-w-md" padding="p-8">
        ...
        <div className="space-y-4">
          <div>
            <label className="text-[10px] font-bold text-gray-gray-500 uppercase tracking-wider block mb-1.5">Username</label>
            <input
              type="text"
              name="username"
              value={form.username}
              onChange={update}
              className="w-full bg-slate-950/60 border border-white/10 rounded-xl px-4 py-2.5 text-base md:text-sm text-white focus:outline-none focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 transition-colors duration-200"
            />
          </div>
            ...
            <div>
              ...
              <div className="relative w-full">
                <select
                  ...
                  value={form.exam_type}
                  onChange={update}
                  className="w-full appearance-none bg-slate-950/60 border border-white/10 rounded-xl px-4 py-2.5 pr-10 text-base md:text-sm text-white focus:outline-none focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 transition-colors duration-200"
                >
                  {uniqueExamTypes.map((et) => (
                    <option key={et.type} value={et.type} className="bg-slate-900 text-white">
                      {et.name}
