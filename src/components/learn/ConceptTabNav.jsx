...
import { Headphones, Target, BarChart2 } from "lucide-react";

export default function ConceptTabNav({ activeTab, onChangeTab }) {
  const tabs = [
    { id: "learn", label: "Vocal Explanation", icon: Headphones },
      ...
      {tabs.map((tab) => {
        ...
        return (
          <button
            ...
            className={`px-4 py-2.5 rounded-xl text-xs font-semibold transition-all border flex items-center gap-1.5 cursor-pointer whitespace-nowrap ${isActive
